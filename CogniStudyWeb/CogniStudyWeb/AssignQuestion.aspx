                                    ...
                                    <asp:UpdatePanel runat="server">
                                        <ContentTemplate>
                                            <asp:GridView ID="grdQuestions" runat="server" CssClass="table table-striped" AutoGenerateColumns="False"
                                                ...
                                                DataSourceID="ObjectDataSource1" OnRowCommand="grdQuestions_RowCommand"
                                                DataKeyNames="ObjectId" OnRowDataBound="grdQuestions_RowDataBound" OnDataBound="grdQuestions_DataBound">
                                                <Columns>
