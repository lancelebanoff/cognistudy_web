...
<asp:CHART id="Chart2" runat="server" Height="100px" Width="500px" BackColor="#D3DFF0" Palette="BrightPastel" 
	...
	<legends>
		<asp:Legend TitleFont="Microsoft Sans Serif, 10pt, style=Bold" BackColor="Transparent" 
	...
	<chartareas>
		<asp:ChartArea Name="ChartArea1" BorderColor="64, 64, 64, 64" BorderDashStyle="Solid" BackSecondaryColor="Transparent" 
			...
			<position Y="40" Height="50" Width="92" X="2"></position>
